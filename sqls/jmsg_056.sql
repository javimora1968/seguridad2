alter table dba.log_accesos  add
       ind_autenticacion_google char(1) null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.log_accesos');
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'log_accesos',
        object_id('dba.log_accesos'),
        'dba',  'ind_autenticacion_google', 11,
        'Ind Autenticacion Google:', 0 ,
        'Ind Autenticacion Google', 0,
       23 , '',
       0 , 65 , 69 ,
        '', 'N',
