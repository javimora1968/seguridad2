  SELECT dba.opciones_modulo_usuario.id_modulo,   
   ...
   WHERE dba.opciones_modulo_usuario.id_modulo = 'm_nomina' AND
			dba.opciones_modulo_usuario.id_usuario='EFGA' and
			dba.opciones_modulo_usuario.id_opcion='m_datoslaboraleshistricose';
