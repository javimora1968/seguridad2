alter table dba.usuarios  add
       acum_reintentos_clave numeric(3,0) null,
       ult_reintento datetime null,
       ind_bloqueado char(1) null,
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        ...
        'dba',  'acum_reintentos_clave', 28,
        'Acum Reintentos Clave:', 0 ,
        'Acum Reintentos Clave', 0,
       24 , '[General]',
       0 , 65 , 142 ,
        '', 'N',
