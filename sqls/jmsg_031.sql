create table dba.log_informes_correo
       (id_empresa char(15) not null,
       cod_informe char(100) not null,
       fecha_correo datetime not null,
       destinatarios text not null);

alter table dba.log_informes_correo
       add constraint pk_log_informes_correo primary key  nonclustered
       (id_empresa,
       cod_informe,
       fecha_correo);
...
insert into dbo.pbcattbl
       ...
       pbt_cmnt)
       values  ( 'log_informes_correo',
       object_id('dba.log_informes_correo'),
        'dba',
        -10,  400,  'N',  'N',  0,  34,
        'Arial',
        -10,  400,  'N',  'N',  0,  34,
