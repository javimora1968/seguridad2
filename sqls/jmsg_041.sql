alter table dba.log_acceso_opciones  add
       serial_pc char(20) null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.log_acceso_opciones');
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'log_acceso_opciones',
        object_id('dba.log_acceso_opciones'),
        'dba',  'serial_pc', 11,
        'Serial Pc:', 0 ,
        'Serial Pc', 0,
       23 , '',
