alter table dba.informes_correo  add
       ind_control_horas char(1) null,
       hora_minima numeric(18,0) null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.informes_correo');
