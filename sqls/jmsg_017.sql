alter table dba.config  add
       obligatorio_cambio_passwd char(1) null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.config');
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        ...
        'dba',  'obligatorio_cambio_passwd', 3,
        'Obligatorio Cambio Passwd:', 0 ,
        'Obligatorio Cambio Passwd', 0,
       23 , '',
       0 , 65 , 69 ,
        '', 'N',
