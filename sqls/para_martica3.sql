create table dba.gl_sector_economico
...
alter table dba.gl_sector_economico
       add constraint pk_gl_sector_economico primary key  nonclustered
       (id_empresa,
       sector);
...
insert into dbo.pbcattbl
       ...
       pbt_cmnt)
       values  ( 'gl_sector_economico',
       object_id('dba.gl_sector_economico'),
        'dba',
        -10,  400,  'N',  'N',  0,  34,
        'Arial',
        -10,  400,  'N',  'N',  0,  34,
