create table dba.gl_subsector_economico
...
alter table dba.gl_subsector_economico
       add constraint pk_gl_subsector_economico primary key  nonclustered
       (id_empresa,
       sector,
       subsector);
...
insert into dbo.pbcattbl
       ...
       pbt_cmnt)
       values  ( 'gl_subsector_economico',
       object_id('dba.gl_subsector_economico'),
        'dba',
        -10,  400,  'N',  'N',  0,  34,
        'Arial',
        -10,  400,  'N',  'N',  0,  34,
